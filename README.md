...
<ul>
<li><i>Cybersecurity Projects:</i> Examples of my work in threat analysis, incident response, and security monitoring.</li>
<li><i>UX Design Portfolio:</i> Showcasing my ability to create intuitive and user-friendly designs.</li>
<li><i>Learning Journey:</i> Documenting my transition from UX design to cybersecurity, including courses, certifications, and hands-on labs.</li>
<li><i>Collaborations:</i> Contributions to open-source cybersecurity projects and collaborations with the security community.</li>
</ul>
